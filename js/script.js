...
$(function () {
 ...
 //services carousel
	$(".services-carousel ul").owlCarousel({
        items: 1,
        navigation: false,
        pagination: true,
        singleItem:true,
...
$('.contact-form').submit(function () {
  ...
  var mssg = document.getElementById("contact_mssg").value;
  var body='<p style="font-size:16px"><b>Name: </b>'+name+'<br><b>Mail: </b>'+email+'<br><b>Subject: </b>'+subject+'<br><b>Message: </b>'+mssg;
  send(body,subject);
});
